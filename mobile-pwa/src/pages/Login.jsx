  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      switch (userRole) {
        case 'Admin':
        case 'Kasa':
          navigate('/dashboard'); // Kasa ve Admin ana yönetim ekranına gider
          break;
        case 'Garson':
          navigate('/waiter-dashboard'); // Garsonları kendi paneline gönder
          break;
        case 'Mutfak':
          navigate('/kitchen-dashboard'); // Mutfakçı doğrudan mutfağa gider!
          break;
        default:
          navigate('/dashboard');
      }
